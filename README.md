...
The essence of this project is to demonstrate how flexible and expedient applications can easily be deployed to the cloud without having to deal with the operational lifting involved when provisioning and managing virtual servers (EC2 instances, as in the case of AWS).
